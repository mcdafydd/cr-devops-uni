...
![Chapter page](/en/level1/pages/images/pages-chapter.png?width=50pc)
...
![Default page](/en/level1/pages/images/pages-default.png?width=50pc)
...
**Hugo-theme-learn** provides [archetypes]({{< relref "level1/archetypes.en.md" >}}) to help you create this kind of pages.
...
![Title with icon](/en/level1/pages/images/frontmatter-icon.png)
