    ...
    return html`
      ...
      <footer id="metaShare">
        <div>
          ...
          <p>Author Justin Ribeiro wrote ${this.metadata.words} words for this piece and hopes you enjoyed it. Find an issue? <a href="https://dev.azure.com/clearesultdev/Evolve/_workitems/create/Issue">File a ticket</a></p>
        </div>
      </footer>
      </article>
